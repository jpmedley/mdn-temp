...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/mdn-temp$1.0.0/templates/event.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<p>{{SeeCompatTable}}{{APIRef(\"" +
    ...
    "!</code></strong> event of the {{domxref(\"" +
    marko_escapeXml(shared.interface) +
    "!\")}} interface is an event handler fired whenever " +
    marko_escapeXml(description) +
    "!.</p><p>This interface inherits from the {{domxref(\"" +
    marko_escapeXml(event - inh) +
    "!\")}} interface.</p><p>{{InheritanceDiagram(700, 60, 20)}}</p><h2 id=\"Syntax\">Syntax</h2><pre class=\"syntaxbox\">" +
...
marko_template.meta = {
    id: "/mdn-temp$1.0.0/templates/event.marko"
  };
